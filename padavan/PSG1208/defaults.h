...
#define DEF_WLAN_2G_SSID	PHICOMM_BOARD_PID "_%s"
#define DEF_WLAN_5G_SSID	PHICOMM_BOARD_PID "_5G_%s"
#define DEF_WLAN_2G_GSSID	PHICOMM_BOARD_PID "_GUEST_%s"
#define DEF_WLAN_5G_GSSID	PHICOMM_BOARD_PID "_GUEST_5G_%s"
